...
class ByteEncoder(nn.Module):
    def __init__(self, cfg):
        super().__init__()
        # cfg is the dict from configurations.config
        ...
        self.num_modalities = cfg.get("num_modalities", 4)
    ...
    def forward(self, byte_input, modality_index):
        ...
        return self.transformer_encoder(x)      # (B, L, D)
