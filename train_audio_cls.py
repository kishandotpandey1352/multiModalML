...
from heads.img_classifier_head import ImageClassifierHead  # reuse same head
...
def main(cfg):
    ...
    try:
        ...
        raise RuntimeError(f"Train split produced 0 samples. "
                        f"Check cfg.parquet_files['{cfg.split_train}'].")
    ...
    def maybe_warmup(epoch):
        if epoch <= warmup_epochs:
            ...
            for g in optim_head.param_groups: g["lr"] = cfg.lr_head * scale
